...
import com.blackflag.foodbank.fragment.TodayFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            //addItems();
            //new TodayFragment.AddAllItemAsyn(TodayFragment.cl).execute();
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new TodayFragment(),"Last Week");
        adapter.addFragment(new TodayFragment(),"Last Month");
        adapter.addFragment(new TodayFragment(),"Search");
